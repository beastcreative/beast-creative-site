      ...
      <section className="relative min-h-[90vh] flex items-center bg-beast-black overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-20 pt-28 pb-24 lg:pt-40 lg:pb-32 w-full">
          ...
          <AnimatedSection delay={0.3}>
            <IconButton href="/growth-assessment?type=cpg" icon="chart">Get My Free CPG Marketing Audit</IconButton>
          </AnimatedSection>
        </div>
      </section>
            ...
            <AnimatedSection>
              <div className="bg-white rounded-2xl p-8 border border-gray-100 h-full flex flex-col">
                ...
                <div className="mt-auto">
                  <IconButton href="/growth-assessment?type=cpg" icon="rocket">I&apos;m an Emerging Brand</IconButton>
                </div>
              </div>
            </AnimatedSection>
            <AnimatedSection delay={0.1}>
              <div className="bg-beast-black rounded-2xl p-8 border border-dark-border h-full flex flex-col">
                ...
                <div className="mt-auto">
                  <IconButton href="/growth-assessment?type=cpg" icon="chart">I&apos;m Ready to Scale</IconButton>
                </div>
              </div>
            </AnimatedSection>
          </div>
