        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20">
          ...
          <AnimatedSection className="mb-4">
            <Link href="/services/seo-aeo" className="group block">
              <div className="relative rounded-2xl overflow-hidden bg-beast-pink p-8 lg:p-12 flex flex-col lg:flex-row lg:items-end justify-between gap-8 border border-transparent transition-all duration-300 group-hover:-translate-y-1 group-hover:border-beast-yellow">
                <div>
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-beast-yellow text-beast-black mb-5">
                    Get Cited by AI
                  </span>
