        ...
        <div className="max-w-3xl mx-auto px-6 lg:px-20 space-y-8">
          ...
          <AnimatedSection>
            <div className="prose prose-lg max-w-none">
              ...
              <ul className="space-y-2 mb-6">
                <li className="flex gap-3 text-[#4A4A4A] text-sm leading-relaxed"><span className="text-beast-pink font-bold shrink-0">→</span> “Natural” has no firm federal definition for most products, which makes it a magnet for consumer class-action lawsuits — use it carefully and be ready to defend it</li>
