...
const faqs = [
  ...
  },
  {
    ...
    answer: "The most reliable wins are in demand forecasting, promotion lift modeling, and cleaning or matching messy data across retailers and naming conventions. AI is also strong at surfacing anomalies, such as a sudden velocity drop in one region, far faster than a human scanning reports. It’s weakest, and most dangerous, when it’s used to imply causation from correlations no one has validated, so keep a human in the loop on any decision with real money behind it.",
  },
];
