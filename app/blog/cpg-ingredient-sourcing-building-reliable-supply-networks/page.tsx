        ...
        <div className="max-w-3xl mx-auto px-6 lg:px-20 space-y-8">
          ...
          <AnimatedSection>
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-[#4A4A4A] leading-relaxed mb-4">One of the earliest structural decisions you’ll make is how many suppliers stand behind each ingredient. Single-sourcing is simpler, often cheaper, and easier to manage on quality — you have one relationship, one spec, one set of paperwork. The problem is obvious the first time that supplier has a fire, a recall, or a capacity crunch and your only source of a hero ingredient goes dark.</p>
              ...
              <ul className="space-y-2 mb-6">
                ...
                <li className="flex gap-3 text-[#4A4A4A] text-sm leading-relaxed"><span className="text-beast-pink font-bold shrink-0">→</span> Spread origins where you can — different farms, regions, or countries reduce correlated risk</li>
              </ul>
          ...
          <AnimatedSection>
            <div className="prose prose-lg max-w-none">
              ...
              <ul className="space-y-2 mb-6">
                ...
                <li className="flex gap-3 text-[#4A4A4A] text-sm leading-relaxed"><span className="text-beast-pink font-bold shrink-0">→</span> Build a real cushion into landed cost — don’t price off your best-ever quote</li>
          ...
          <AnimatedSection>
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-[#4A4A4A] leading-relaxed mb-4">Trust the supplier, verify the lot. Incoming inspection, periodic independent testing, and supplier audits keep the relationship honest and catch drift before it reaches a consumer. The brands that get burned are usually the ones who stopped checking once a supplier had been reliable for a while — exactly when complacency sets in upstream too.</p>
          ...
          <AnimatedSection>
            <div className="prose prose-lg max-w-none">
              ...
              <ul className="space-y-2 mb-6">
                ...
                <li className="flex gap-3 text-[#4A4A4A] text-sm leading-relaxed"><span className="text-beast-pink font-bold shrink-0">→</span> Revisit single-source decisions — concentration that was fine small can be fatal large</li>
              </ul>
