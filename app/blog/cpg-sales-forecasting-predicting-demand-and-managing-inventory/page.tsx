...
const faqs = [
  {
    ...
    answer: "It depends entirely on what you’re forecasting and at what level. A national, monthly baseline forecast for an established, slow-moving SKU might land at 10–20% MAPE, while a weekly, store-level forecast for a promoted item can easily run 40% or higher and still be useful. The right question isn’t “is my MAPE low” but “is it better than a naive forecast and is it improving over time.” Chase the items where small accuracy gains free up the most working capital, not a universal target number.",
  },
  {
  ...
  },
  {
    ...
    answer: "Baseline demand is what you’d sell at everyday price with no promotion—the steady, repeatable volume your forecast can lean on. Promoted demand is the lift on top of that baseline driven by price discounts, displays, features, and TPRs, and it’s far more volatile because it depends on depth, timing, and retailer execution. Separating the two is essential: if you don’t decompose the lift, every past promotion contaminates your baseline and you’ll over-forecast quiet weeks and under-forecast promoted ones. Forecast baseline and lift separately, then add them back together.",
  },
  {
