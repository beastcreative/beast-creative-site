...
const results = [
  { label: "Idea → launched SaaS in one week", detail: "vs the 6–12 month industry norm for a product of this scope." },
  { label: "Every K–12 standard, all subjects", detail: "a full standards database powering the generation engine." },
  { label: "Six resource types × four reading levels", detail: "worksheets, lesson plans, exit tickets, assessments, and more — each differentiated below / on / above grade + ELL." },
