            ...
            <div className="lg:col-span-2 space-y-12 order-2 lg:order-1">
              ...
              <AnimatedSection>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    { label: "Experience brand.", detail: "Unlike a product or service, an arcade barcade is the experience. The brand had to work as environmental design, wearable merchandise, digital content, and a physical space, all at the same time." },
                  ].map((item) => (
              ...
              <AnimatedSection>
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 leading-relaxed mb-3">
                      Beast ran a full naming exercise involving dozens of candidates across multiple naming frameworks: descriptive, evocative, abstract, cultural reference, invented. The criteria were strict: relevant without being generic, scalable beyond a single location, memorable and ownable, works visually as a logo, and ambiguous enough to intrigue people who don&apos;t know the reference.
                    </p>
                    <p className="text-gray-600 leading-relaxed mb-3">
              ...
              <AnimatedSection>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    { label: "Brand Name & Strategy", detail: "The name Coinline, its rationale, cultural positioning, and competitive differentiation, all documented so every team member and partner can communicate it consistently." },
      ...
      <section className="bg-beast-black py-16 text-center">
        <div className="max-w-2xl mx-auto px-6">
          <AnimatedSection>
            ...
            <IconButton href="/growth-assessment" icon="rocket">Start Your Growth Assessment</IconButton>
          </AnimatedSection>
        </div>
      </section>
    </>
